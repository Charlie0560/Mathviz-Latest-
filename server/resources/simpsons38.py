...
def postI():
    ...
    try:
        ax.set_title(f"Simpsons 3/8 rule: plot of f = {fx}")
...
@simpsons38.route("/runGraphsII", methods=["POST"])  # With partition
def postII():
    # Code to accept input from the user.
    input = request.json
...
def post1():
    ...
    dataStr = {"a": lst, "area1": Simson, "area2": I}
