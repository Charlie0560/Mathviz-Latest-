  ...
  return (
    <>
      <Grid container spacing={2} sx={{ paddingInline: "15%" }}>
        ...
        <Grid item xs={12}>
          <p className="theory-text">
            ...
            <i>
              ...
              of f(x) near the beginning of the set of values given. h is called
              the interval of difference and u = ( x – a ) / h, Here a is the
              first term.
            </i>
            <br></br>
          </p>
        ...
        <Grid item xs={12}>
          <center>
            <img src={newb} alt="formula" style={{ width: "60%" }} />
          </center>
        </Grid>
